        ...
        <div id="principal">
            <form action="" method="POST">
                ...
                <fieldset class="gerais">
                    ...
                    <legend>Dados Gerais do Cliente</legend>
                    ...
                    <div>
                        <div class="medio-esquerda">
                            <label >CPF: </label>
                            <input type="text" name="cpf" class="campo-medio">
                        </div>
    
                        <div class="medio-esquerda">
                            <label >RG: </label>
                            <input type="text" name="rg" class="campo-medio">
                        </div>
                    </div>        
                ...
                <div id="div-botoes">
                    ...
                    <button type="submit" id="botao-salvar">
                        <p id="texto-botoes">Salvar Clientes</p>
                    </button>
                </div>
